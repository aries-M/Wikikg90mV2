...
logging.basicConfig(level=logging.INFO, filemode='a', filename="test.log", format='%(asctime)s - %(name)s - %(levelname)s - %(message)s')
...
def _get_args():
    ...
    parser.add_argument('--manual_feature_path', default="/mnt/xu/azure_storage/usscv100data/manual_feature/autosf_concat-complex_shallow-distmult_shallow-smore-autosf-complex_e-distmult_g-transe_l2-rule/valid_feats")
...
if __name__ == "__main__":
    ...
    if args.preprocess:
        ...
        logger.info("finish loading infer_rst_val_path_list")
        ...
        for feat_name in feat_names:
            path = f"{args.manual_feature_path}/{feat_name}"
