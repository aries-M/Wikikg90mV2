...
class KGDatasetWiki(KGDataset):
    ...
    def __init__(self, path, name='wikikg90m', test_mode='test-dev'):
        ...
        #     self.test_dict['h,r->t']['t_candidate'] = np.load(os.path.join(path, 'wikikg90m-v2', 'processed', 'test-dev_t_candidate.npy'))
        # else:
        #     self.test_dict['h,r->t']['t_candidate'] = np.load(os.path.join(path, 'wikikg90m-v2', 'processed', 'test-challenge_t_candidate.npy'))
